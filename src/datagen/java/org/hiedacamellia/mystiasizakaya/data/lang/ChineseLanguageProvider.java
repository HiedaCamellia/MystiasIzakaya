package org.hiedacamellia.mystiasizakaya.data.lang;
...
public class ChineseLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.mystias_izakaya.table.title", "餐桌 #%d");
        ...
        add("mystias_izakaya.configuration.enable_all_cuisines", "允许餐桌放入任何料理");
        add("mystias_izakaya.configuration.order_refresh_interval", "尝试刷新订单的间隔");
        add("mystias_izakaya.configuration.order_refresh_probability", "每次尝试刷新订单的概率");
        add("mystias_izakaya.configuration.enable_all_beverages", "允许餐桌放入任何饮品");
        add("mystias_izakaya.configuration.enable_all_ingredients", "允许厨具放入任何食材");
    }
}
