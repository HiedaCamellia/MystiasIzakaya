...
public class EnglishLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("gui.mystias_izakaya.table.title", "Table #%d");
        ...
        add("mystias_izakaya.configuration.enable_all_cuisines", "Enable put any cuisines in table");
        add("mystias_izakaya.configuration.order_refresh_interval", "The interval of refreshing the order");
        add("mystias_izakaya.configuration.order_refresh_probability", "The probability of refreshing the order");
        add("mystias_izakaya.configuration.enable_all_beverages", "Enable put any beverages in table");
        add("mystias_izakaya.configuration.enable_all_ingredients", "Enable put any ingredients in kitchenware");
