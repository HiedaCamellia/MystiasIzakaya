...
package net.touhou.mystiasizakaya.world.inventory;

import net.touhou.mystiasizakaya.procedures.LockProcedure;
	...
	public CookingRangeUiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 203, 62) {
			...
			public boolean mayPickup(Player entity) {
				return !LockProcedure.execute(world, x, y, z);
			}

			@Override
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("mystiasizakaya:kitchenwares")));
			}
		}));
