...
public class BankBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(0, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public BankBlockEntity(BlockPos position, BlockState state) {
		super(MystiasIzakayaModBlockEntities.BANK.get(), position, state);
	}
