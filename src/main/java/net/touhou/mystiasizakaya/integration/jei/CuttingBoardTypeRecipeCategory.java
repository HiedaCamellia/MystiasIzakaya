...
public class CuttingBoardTypeRecipeCategory implements IRecipeCategory<CuttingBoardTypeRecipe> {
	...
	public CuttingBoardTypeRecipeCategory(IGuiHelper helper) {
		...
		this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(MystiasIzakayaModItems.LIAO_LI_TAI.get()));
	}

	@Override
	public mezz.jei.api.recipe.RecipeType<CuttingBoardTypeRecipe> getRecipeType() {
		return MystiasIzakayaModJeiPlugin.CuttingBoardType_Type;
	}
