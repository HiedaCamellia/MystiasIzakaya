...
import net.touhou.mystiasizakaya.item.cuisines.ZhuTongZhengDanItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhuSunChaoRouItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhuRouZunYuXunItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhuRouGaiJiaoFanItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhuQuJiItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhuLuDieItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhuDouFuItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhiZhuRouFanTuanItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhenHaiXianWeiChengTangItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhaZhuRouPaiItem;
import net.touhou.mystiasizakaya.item.cuisines.ZhaBaMuManItem;
import net.touhou.mystiasizakaya.item.cuisines.ZaChuiItem;
import net.touhou.mystiasizakaya.item.cuisines.YueZhiLianRenItem;
import net.touhou.mystiasizakaya.item.cuisines.YueGuangTuanZiItem;
import net.touhou.mystiasizakaya.item.cuisines.YouDouFuItem;
import net.touhou.mystiasizakaya.item.cuisines.YingLuoXueItem;
import net.touhou.mystiasizakaya.item.cuisines.YiShiHuiFanItem;
import net.touhou.mystiasizakaya.item.cuisines.YeWeiJiaNongItem;
import net.touhou.mystiasizakaya.item.cuisines.YanJiangItem;
import net.touhou.mystiasizakaya.item.cuisines.XingHongEMoDanGaoItem;
import net.touhou.mystiasizakaya.item.cuisines.XiangZhaChanShuiItem;
import net.touhou.mystiasizakaya.item.cuisines.XiangJianSanWenYuItem;
import net.touhou.mystiasizakaya.item.cuisines.WuYiShiYaoGuaiMuSiItem;
import net.touhou.mystiasizakaya.item.cuisines.WenNuanFanTuanItem;
import net.touhou.mystiasizakaya.item.cuisines.TunGuLaMianItem;
import net.touhou.mystiasizakaya.item.cuisines.TuDouKeLeBingItem;
import net.touhou.mystiasizakaya.item.cuisines.TaoHuaGengItem;
import net.touhou.mystiasizakaya.item.cuisines.SiKangBingItem;
import net.touhou.mystiasizakaya.item.cuisines.ShuiJiaoItem;
import net.touhou.mystiasizakaya.item.cuisines.ShuCaiZhuanJiItem;
import net.touhou.mystiasizakaya.item.cuisines.ShiLiYinXingItem;
import net.touhou.mystiasizakaya.item.cuisines.SaiXiongZhangItem;
import net.touhou.mystiasizakaya.item.cuisines.ReSongBingItem;
import net.touhou.mystiasizakaya.item.cuisines.PengLaiYuZhiItem;
import net.touhou.mystiasizakaya.item.cuisines.NiuRouGaiJiaoFanItem;
import net.touhou.mystiasizakaya.item.cuisines.NengLiangChuanItem;
import net.touhou.mystiasizakaya.item.cuisines.NaiYouTunCaiItem;
import net.touhou.mystiasizakaya.item.cuisines.MoGuRouPianItem;
import net.touhou.mystiasizakaya.item.cuisines.MiZhiXiaoYuGanItem;
import net.touhou.mystiasizakaya.item.cuisines.MiZhiChaShaoItem;
import net.touhou.mystiasizakaya.item.cuisines.MaoYuSanSeBingJiLingItem;
import net.touhou.mystiasizakaya.item.cuisines.MaoYuRongYanDouFuItem;
import net.touhou.mystiasizakaya.item.cuisines.MaShuItem;
import net.touhou.mystiasizakaya.item.cuisines.MaPoDouFuItem;
import net.touhou.mystiasizakaya.item.cuisines.LuShuiZhuDanItem;
import net.touhou.mystiasizakaya.item.cuisines.LiuShuiSuMianItem;
import net.touhou.mystiasizakaya.item.cuisines.LiangCaiDiaoHuaItem;
import net.touhou.mystiasizakaya.item.cuisines.LiLiangTangItem;
import net.touhou.mystiasizakaya.item.cuisines.LengDouFuItem;
import net.touhou.mystiasizakaya.item.cuisines.KaoMoGuItem;
import net.touhou.mystiasizakaya.item.cuisines.KaoBaMuManItem;
import net.touhou.mystiasizakaya.item.cuisines.HuiLingDunNiuPaiItem;
import net.touhou.mystiasizakaya.item.cuisines.HuangYouNiuPaiItem;
import net.touhou.mystiasizakaya.item.cuisines.HuanTanHuaGaoItem;
import net.touhou.mystiasizakaya.item.cuisines.HuaGuangYuJianBaoItem;
import net.touhou.mystiasizakaya.item.cuisines.HongShaoManYuItem;
import net.touhou.mystiasizakaya.item.cuisines.HaiXianWeiChengTangItem;
import net.touhou.mystiasizakaya.item.cuisines.FanTuanItem;
import net.touhou.mystiasizakaya.item.cuisines.ErTianLiuItem;
import net.touhou.mystiasizakaya.item.cuisines.DouFuWeiChengItem;
import net.touhou.mystiasizakaya.item.cuisines.DouFuGuoItem;
import net.touhou.mystiasizakaya.item.cuisines.DaSheYanItem;
import net.touhou.mystiasizakaya.item.cuisines.DaBanShaoItem;
import net.touhou.mystiasizakaya.item.cuisines.CiShenPinPanItem;
import net.touhou.mystiasizakaya.item.cuisines.ChouDouFuItem;
import net.touhou.mystiasizakaya.item.cuisines.ChaoRouSiItem;
import net.touhou.mystiasizakaya.item.cuisines.BuSiNiaoItem;
import net.touhou.mystiasizakaya.item.cuisines.BeiJiTianXiaMiTaoSeLaItem;
import net.touhou.mystiasizakaya.item.cuisines.BanNiDiKeDanItem;
import net.touhou.mystiasizakaya.item.cuisines.BaiXueItem;
import net.touhou.mystiasizakaya.item.cuisines.BaiTaoShengBaQiaoItem;
import net.touhou.mystiasizakaya.item.cuisines.BaiGuoLuoBuPaiGuTangItem;
