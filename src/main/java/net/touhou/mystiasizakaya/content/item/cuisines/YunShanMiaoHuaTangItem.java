...
public class YunShanMiaoHuaTangItem extends Item {
	public YunShanMiaoHuaTangItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			List<String> description = Arrays.asList(Component
					.translatable("tooltip.mystias_izakaya.yun_shan_miao_hua_tang").getString().split("§n"));
