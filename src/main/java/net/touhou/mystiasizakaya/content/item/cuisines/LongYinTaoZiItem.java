...
public class LongYinTaoZiItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			List<String> description = Arrays.asList(Component
					.translatable("tooltip.mystias_izakaya.long_yin_tao_zi").getString().split("§n"));
	...
	public static List<String> getnegativetags() {
		...
		list.add("tag.mystias_izakaya.PeculiarX");
		list.add("tag.mystias_izakaya.RawX");
		return list;
	}
}
