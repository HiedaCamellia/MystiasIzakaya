...
public class DouFuWeiChengItem extends Item {
	public DouFuWeiChengItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			String[] description = (Component.translatable("tooltip.mystias_izakaya.dou_fu_wei_cheng").getString().split("§n"));
