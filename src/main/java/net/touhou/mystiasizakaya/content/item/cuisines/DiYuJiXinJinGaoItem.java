...
public class DiYuJiXinJinGaoItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			List<String> description = Arrays.asList(Component
					.translatable("tooltip.mystias_izakaya.di_yu_ji_xin_jin_gao").getString().split("§n"));
	...
	public static List<String> gettags() {
		...
		list.add("tag.mystias_izakaya.Expenisve");
		...
		list.add("tag.mystias_izakaya.Spicy");
		list.add("tag.mystias_izakaya.Peculiar");
		list.add("tag.mystias_izakaya.Strength-Boosting");
		return list;
	}
