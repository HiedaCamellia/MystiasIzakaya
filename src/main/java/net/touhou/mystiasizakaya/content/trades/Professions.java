...
public class Professions {
	...
	public static final RegistryObject<VillagerProfession> TRADER = registerProfession("trader", () -> ModBlocks.COOKING_RANGE.get(), () -> ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.smoker.smoke")));
