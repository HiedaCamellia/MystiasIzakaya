...
public class ShuiJiaoItem extends Item {
	public ShuiJiaoItem() {
		super(new Item.Properties().tab(MystiasIzakayaModTabs.MystiasIzakaya).stacksTo(64).rarity(Rarity.UNCOMMON)
				.food((new FoodProperties.Builder()).nutrition(6).saturationMod(5f).alwaysEat().build()));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			List<String> description = Arrays
					.asList(Component.translatable("tooltip.mystias_izakaya.shui_jiao").getString().split("§n"));
