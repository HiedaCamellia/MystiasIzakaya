...
public class ZhaBaMuManItem extends Item {
	public ZhaBaMuManItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.UNCOMMON)
				.food((new FoodProperties.Builder()).nutrition(8).saturationMod(5f).alwaysEat().build()));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			List<String> description = Arrays
					.asList(Component.translatable("tooltip.mystias_izakaya.zha_ba_mu_man").getString().split("§n"));
