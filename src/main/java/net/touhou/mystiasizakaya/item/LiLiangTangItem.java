...
public class LiLiangTangItem extends Item {
	public LiLiangTangItem() {
		super(new Item.Properties().tab(MystiasIzakayaModTabs.MystiasIzakaya).stacksTo(64).rarity(Rarity.UNCOMMON)
				.food((new FoodProperties.Builder()).nutrition(14).saturationMod(11.5f).alwaysEat().build()));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			List<String> description = Arrays
					.asList(Component.translatable("tooltip.mystias_izakaya.li_liang_tang").getString().split("§n"));
	...
	public static List<String> gettags() {
		...
		list.add("tag.mystias_izakaya.Strength_Boosting");
		list.add("tag.mystias_izakaya.Soup");
		return list;
	}
	...
	public static List<String> getnegativetags() {
		...
		list.add("tag.mystias_izakaya.Refreshing");
		return list;
	}
}
