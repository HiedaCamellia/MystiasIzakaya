...
public class XiangJianSanWenYuItem extends Item {
	public XiangJianSanWenYuItem() {
		super(new Item.Properties().tab(MystiasIzakayaModTabs.MystiasIzakaya).stacksTo(64).rarity(Rarity.RARE)
				.food((new FoodProperties.Builder()).nutrition(12).saturationMod(8f).alwaysEat().build()));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			List<String> description = Arrays.asList(
					Component.translatable("tooltip.mystias_izakaya.xiang_jian_san_wen_yu").getString().split("§n"));
