...
import net.touhou.mystiasizakaya.init.MystiasIzakayaModVillagerProfessions;
...
import net.touhou.mystiasizakaya.init.MystiasIzakayaModBlocks;
...
@Mod("mystias_izakaya")
public class MystiasIzakayaMod {
	public static final Logger LOGGER = LogManager.getLogger(MystiasIzakayaMod.class);
	public static final String MODID = "mystias_izakaya";

	public MystiasIzakayaMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		MystiasIzakayaModBlocks.REGISTRY.register(bus);
