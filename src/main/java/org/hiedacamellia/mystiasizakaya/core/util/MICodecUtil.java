...
public class MICodecUtil {
    ...
    public static final Codec<Pair<String,Double>> TURNOVER_CODEC = new PairCodec<>(Codec.STRING,Codec.DOUBLE);
    ...
    public static final Codec<ArrayList<Pair<String,Double>>> LIST_TURNOVER_CODEC = RecordCodecBuilder.create(instance ->
            instance.group(MICodecUtil.TURNOVER_CODEC.listOf().fieldOf("list").forGetter((e)->e)).apply(instance, ArrayList::new)
    );
