    ...
    public void init() {
        ...
        for (int si = 0; si < 3; ++si)
            for (int sj = 0; sj < 9; ++sj)
                this.addRenderableWidget(new RenderSlot(start_x + 8 + sj * 18, 2 + start_y + si * 18, Component.empty()));
        for (int si = 0; si < 9; ++si)
            this.addRenderableWidget(new RenderSlot(start_x + 8 + si * 18, 6 + start_y + 3 * 18, Component.empty()));

        this.addRenderableWidget(new RenderSlot( this.leftPos + 70, this.topPos + 30, Component.empty()));
        this.addRenderableWidget(new RenderSlot(this.leftPos + 100, this.topPos + 30, Component.empty()));
    }
