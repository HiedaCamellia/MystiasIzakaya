...
public class Professions {
	...
	public static final DeferredHolder<VillagerProfession, VillagerProfession> TRADER = registerProfession("trader", ModBlocks.COOKING_RANGE, () -> BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("block.smoker.smoke")));
