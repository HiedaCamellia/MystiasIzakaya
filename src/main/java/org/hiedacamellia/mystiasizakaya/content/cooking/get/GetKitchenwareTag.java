...
public class GetKitchenwareTag {
	public static List<String> execute(ItemStack Kitchenware) {

        List<String> tags = Kitchenware.getOrCreateTag().getString("tags").isEmpty() ? List.of() : List.of(Kitchenware.getOrCreateTag().getString("tags").split(","));
