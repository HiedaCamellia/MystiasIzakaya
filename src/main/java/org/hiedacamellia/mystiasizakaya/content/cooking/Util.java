...
public class Util {
	...
	public static ItemStack buildTag(RecipeManager recipeManager, ItemStack target, ItemStack Kitchenware, List<ItemStack> ingredients) {
		...
		List<String> rawtags = Util.getTag(recipeManager,target, new ArrayList<>(ingredients),Kitchenware);
