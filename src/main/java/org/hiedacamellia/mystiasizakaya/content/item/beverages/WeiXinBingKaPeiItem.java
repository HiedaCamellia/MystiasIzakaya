...
public class WeiXinBingKaPeiItem extends Item {
	public WeiXinBingKaPeiItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			String[] description = (Component.translatable("tooltip.mystias_izakaya.wei_xin_bing_ka_pei").getString().split("§n"));
