...
public class GuoWeiSOURItem extends Item {
	public GuoWeiSOURItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			String[] description = (Component.translatable("tooltip.mystias_izakaya.guo_wei_sour").getString().split("§n"));
...
public static List<String> gettags() {
		...
		list.add("tag.mystias_izakaya.beverages.shochu");
