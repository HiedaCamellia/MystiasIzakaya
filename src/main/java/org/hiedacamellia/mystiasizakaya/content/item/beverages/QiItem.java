...
public class QiItem extends Item {
	public QiItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		if (!Screen.hasShiftDown()) {
			...
			String[] description = (Component.translatable("tooltip.mystias_izakaya.qi").getString().split("§n"));
...
public static List<String> gettags() {
		...
		list.add("tag.mystias_izakaya.beverages.sake");
		...
		list.add("tag.mystias_izakaya.beverages.dry");
